                    ...
                    <div class="table-responsive p-0">
                        <form class="px-5 py-1" method="post" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="nbrnuit" type="number" placeholder="how mush night in this cruise" min=1 id="nbrnuit"
                                       required>
                            </div>
                            <div class="form-group">
...
<script>
    ...
    function addCruisesinput(i) {
        ...
        <div class="position-relative d-flex align-items-center" id="cruiseitinery${i}">
            <select class="form-control" name="cruiseitinery${i}" required>
