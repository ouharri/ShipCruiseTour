<?php include_once VIEWS . 'component' . DS . 'user' . DS . 'header.php'; ?>
    ...
    <div class="WavesContainer">
        <div class="container seach" id="searchBox"
            ...
            <div class="col-lg-12">
                <form id="search-form" class="search-form" method="post" role="search" action="<?= url('cuirses/search') ?>">
                    <div class="row">
        ...
        <h1 class="cruisesh1 text-primary" id="searchText">youre cruises</h1>
        <!--Waves Container-->
                                    ...
                                    <div class="row p-1">
                                        ...
                                        <div class="card-body col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start d-flex flex-column justify-content-center align-items-center">
                                            <div class="d-flex flex-row align-items-center mb-1">
                                                <h4 class="mb-1 me-1"
                                                    style="color: #061556; font-size: 50px;"><?= $c['prix'] ?>
                                                    DH</h4>
                                            </div>
