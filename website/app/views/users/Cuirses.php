...
<section id="cruisesDetail">
    <div id="cruisesDetailBntX">
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24"
             style="fill: rgb(123, 188, 209);transform: ;msFilter:;">
            <path d="m16.192 6.344-4.243 4.242-4.242-4.242-1.414 1.414L10.535 12l-4.242 4.242 1.414 1.414 4.242-4.242 4.243 4.242 1.414-1.414L13.364 12l4.242-4.242z"></path>
        </svg>
    </div>
    <img id="cruisesDetailImg" src="<?= url('images/pexels-pixabay-533937.jpg'); ?>">
    <div class="row justify-content-center w-100">
        <div class="col-md-12 col-xl-10">
            <div class="container shadow-0rounded-3">
                <div class="" id="">
                    <div class="row p-1">
                        <div class="col-md-6 col-lg-6 col-xl-6 p-10 card-body">
                            <h5 class="mt-3"
                            ...
                            <div class="sizes mt-5">
                                <h6 class="text-uppercase">chose your Rom</h6> <label class="radio"> <input type="radio"
                                                                                                            name="size"
                                                                                                            value="S"
                                                                                                            checked>
                                    <span>S</span> </label> <label class="radio"> <input type="radio" name="size"
                                                                                         value="M"> <span>M</span>
                                </label> <label class="radio"> <input type="radio" name="size" value="L"> <span>L</span>
                        ...
                        <div class="card-body col-md-6 col-lg-3 col-xl-3 d-flex flex-column justify-content-center align-items-center"
                            ...
                            <div class="d-flex flex-column align-items-start mb-1">
                                <p style="color: #061556; font-size: 20px; font-weight: unset" class="px-3">VISITING
                                    :</p>
                                <div class="timelines">
                                    <div class='wrapper'>
                                        <div class='steps' id='steps'>
                                            <div class='step'>
                                                ...
                                                <div class='info'>
                                                    ...
                                                    <p class='text'>
                                                        <?= $c['cruiseItinery'][count($c['cruiseItinery']) - 1]['city'] ?>
                                                        .</p>
                                                </div>
                                            </div>
                                            <?php $i = 1;
...
<script>
    const cruisesDetail = document.getElementById('cruisesDetail');
    const cruisesDetailBntX = document.getElementById('cruisesDetailBntX');

    cruisesDetailBntX.onclick = () => {
        cruisesDetail.innerHTML = '';
        cruisesDetail.style.display = 'none';
    }
        ...
        $.ajax(
            {
                ...
                success: function (data) {
                    ...
                    console.log((data));
                    let cruisesData = document.createElement("section");
                    ...
                    <img id="cruisesDetailImg" src="${cruise.img}">

                    `;
                    cruisesMain.appendChild(cruisesData);
