...
<div class="container-fluid d-flex align-items-center justify-content-center"
    ...
    <h1 class="text-center resText">Mes réservations :</h1>
</div>
        ...
        <?php if (!empty($reservation)) {
                                ...
                                <div class="row p-1">
                                    ...
                                    <div class="card-body col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start d-flex flex-column justify-content-center align-items-center">
                                        ...
                                        <div class="d-flex flex-column mt-4">
                                            ...
                                            <button class="btn btn-outline-primary btn-sm mt-2 btn-reservation d-flex justify-content-center align-items-center text-center"
                                                    hidden-print
            ...
            <div id="notfound">
                <div class="notfound">
                    ...
                    <a href="<?= url('cuirses') ?>">Reserve Now</a>
                </div>
            </div>
        <?php } ?>
    </div>
