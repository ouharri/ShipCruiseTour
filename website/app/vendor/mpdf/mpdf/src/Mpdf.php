...
class Mpdf implements \Psr\Log\LoggerAwareInterface
{
	...
	var $fullImageHeight;
var $inFixedPosBlock;
var $fixedPosBlock;  // Internal flag for position:fixed block
		var $fixedPosBlockDepth;  // Buffer string for position:fixed block
...
var $docTemplateStart;
	var $time0;  // Internal flag for page (page no. -1) that docTemplate starts on
...
var $writingHTMLheader;
	var $writingHTMLfooter; // internal flag - used both for writing HTMLHeaders/Footers and FixedPos block
	var $angle;
	var $gradients;
	var $kwt_Reference;
	var $kwt_BMoutlines;
	...
	var $arabNextLink;
var $formobjects;
	var $InlineProperties; // array of Form Objects for WMF
	var $InlineAnnots;
var $InlineBDF;
	var $InlineBDFctr; // mPDF 6 Bidirectional formatting
		var $ktAnnots; // mPDF 6
	var $tbrot_Annots;
	var $kwt_Annots;
	var $columnAnnots;
	...
	var $PageAnnots;
var $pageDim;
	var $breakpoints; // Keep track of page wxh for orientation changes - set in _beginpage, used in _putannots
	var $tableLevel;
	var $tbctr;
	...
	var $page_box;
var $show_marks;
	var $basepathIsLocal; // crop or cross marks
	var $use_kwt;
	var $kwt;
	var $kwt_height;
	var $kwt_y0;
	...
	// SetProtection
var $enc_obj_id;
	var $BMoutlines; // encryption object id
	...
	var $NbCol;
var $y0;
		var $ColL;   // Top ordinate of columns
	var $ColWidth;
	var $ColGap;
	var $ColR;
...
var $substitute;
	...
	// Substitutions
	var $entsearch;  // Array of substitution strings e.g. <ttz>112</ttz>
	var $entsubstitute;  // Array of HTML entities (>ASCII 127) to substitute
		var $defaultCSS; // Array of substitution decimal unicode for the Hi entities

	// Default values if no style sheet offered	(cf. http://www.w3.org/TR/CSS21/sample.html)
	var $defaultCssFile;
var $lastoptionaltag;
	var $pageoutput; // Save current block item which HTML specifies optionsl endtag
	var $charset_in;
	var $blk;
	var $blklvl;
	var $ColumnAdjust;
var $ws;
	var $HREF; // Word spacing
	var $pgwidth;
	var $fontlist;
	var $oldx;
	var $oldy;
...
var $keep_block_together;
	var $tbrot_y0; // Keep a Block from page-break-inside: avoid
	var $tbrot_x0;
	var $tbrot_w;
	var $tbrot_h;
	var $mb_enc;
	...
	var $directionality;
var $extgstates;
	var $mgl; // Used for alpha channel - Transparency (Watermark)
	var $mgt;
	var $mgr;
	var $mgb;
	var $tts;
...
var $default_font_size;
	var $original_default_font_size; // in pts
		var $original_default_font; // used to save default sizes when using table default
	var $watermark_font;
	var $defaultAlign;
...
var $shrin_k;
var $shrink_this_table_to_fit; // factor with which to shrink tables - used internally - do not change
	var $MarginCorrection; // 0 or false to disable; value (if set) gives maximum factor to reduce fontsize
		var $margin_footer; // corrects for OddEven Margins
	var $margin_header;
...
var $page;
var $n; // current page number
var $n_js; // current object number
		var $n_ocg_hidden; // current object number
	var $n_ocg_print;
	var $n_ocg_view;
var $offsets;
var $buffer; // array of object offsets
	var $pages; // buffer holding in-memory PDF
	var $state; // array containing pages
	var $compress; // current document state
	var $DefOrientation; // compression flag
var $CurOrientation; // default orientation
	var $OrientationChanges; // current orientation
		var $fwPt; // array indicating orientation changes
var $fhPt;
		var $fw; // dimensions of page format in points
var $fh;
		var $wPt; // dimensions of page format in user unit
var $hPt;
		var $w; // current dimensions of page in points
var $h;
	var $lMargin; // current dimensions of page in user unit
var $tMargin; // left margin
	var $rMargin; // top margin
	var $bMargin; // right margin
	var $cMarginL; // page break margin
	var $cMarginR; // cell margin Left
	var $cMarginT; // cell margin Right
	var $cMarginB; // cell margin Left
	var $DeflMargin; // cell margin Right
var $DefrMargin; // Default left margin
		var $x; // Default right margin
var $y;
	var $lasth; // current position in user unit for cell positioning
var $LineWidth; // height of last cell printed
	var $CoreFonts; // line width in user unit
var $fonts; // array of standard font names
	var $FontFiles; // array of used fonts
	var $images; // array of font files
var $imageVars = []; // array of used images
	var $PageLinks; // array of image vars
var $links; // array of links in pages
	var $FontFamily; // array of internal links
	var $FontStyle; // current font family
	var $CurrentFont; // current font style
	var $FontSizePt; // current font info
	var $FontSize; // current font size in points
	var $DrawColor; // current font size in user unit
	var $FillColor; // commands for drawing color
	var $TextColor; // commands for filling color
	var $ColorFlag; // commands for text color
	var $autoPageBreak; // indicates whether fill and text colors are different
	var $PageBreakTrigger; // automatic page breaking
	var $InFooter; // threshold used to trigger page breaks
		var $InHTMLFooter; // flag set when processing footer
var $processingFooter;
	var $processingHeader; // flag set when processing footer - added for columns
	var $ZoomMode; // flag set when processing header - added for columns
	var $LayoutMode; // zoom display mode
	var $title; // layout display mode
	var $subject; // title
	var $author; // subject
	var $keywords; // author
	var $creator; // keywords
	var $customProperties; // creator
var $associatedFiles; // array of custom document properties
var $additionalXmpRdf; // associated files (see SetAssociatedFiles below)
	var $aliasNbPg; // additional rdf added in xmp
var $aliasNbPgGp; // alias for total number of pages
		var $ispre; // alias for total number of pages in page group
	var $outerblocktags;
	var $innerblocktags;
