...
const UNICODE_GENERAL_CATEGORY_UPPERCASE_LETTER = 9;
    ...
    // hb-unicode.h
    const UNICODE_GENERAL_CATEGORY_SPACING_MARK = 10;   /* Cc */
    const UNICODE_GENERAL_CATEGORY_ENCLOSING_MARK = 11;   /* Cf */
    const UNICODE_GENERAL_CATEGORY_NON_SPACING_MARK = 12;   /* Cn */
    const UNICODE_GENERAL_CATEGORY_DECIMAL_NUMBER = 13;   /* Co */
    const UNICODE_GENERAL_CATEGORY_LETTER_NUMBER = 14;   /* Cs */
    const UNICODE_GENERAL_CATEGORY_OTHER_NUMBER = 15;  /* Ll */
    const UNICODE_GENERAL_CATEGORY_CONNECT_PUNCTUATION = 16;  /* Lm */
    const UNICODE_GENERAL_CATEGORY_DASH_PUNCTUATION = 17;  /* Lo */
    const UNICODE_GENERAL_CATEGORY_CLOSE_PUNCTUATION = 18;  /* Lt */
    const UNICODE_GENERAL_CATEGORY_FINAL_PUNCTUATION = 19;  /* Lu */
    const UNICODE_GENERAL_CATEGORY_INITIAL_PUNCTUATION = 20;  /* Mc */
    const UNICODE_GENERAL_CATEGORY_OTHER_PUNCTUATION = 21;  /* Me */
    const UNICODE_GENERAL_CATEGORY_OPEN_PUNCTUATION = 22;  /* Mn */
    const UNICODE_GENERAL_CATEGORY_CURRENCY_SYMBOL = 23;  /* Nd */
    const UNICODE_GENERAL_CATEGORY_MODIFIER_SYMBOL = 24;  /* Nl */
    const UNICODE_GENERAL_CATEGORY_MATH_SYMBOL = 25;  /* No */
    const UNICODE_GENERAL_CATEGORY_OTHER_SYMBOL = 26; /* Pc */
    const UNICODE_GENERAL_CATEGORY_LINE_SEPARATOR = 27;  /* Pd */
    const UNICODE_GENERAL_CATEGORY_PARAGRAPH_SEPARATOR = 28; /* Pe */
    const UNICODE_GENERAL_CATEGORY_SPACE_SEPARATOR = 29; /* Pf */
        const BIDI_CLASS_L = 0; /* Pi */
        const BIDI_CLASS_LRE = 1; /* Po */
        const BIDI_CLASS_LRO = 2;  /* Ps */
        const BIDI_CLASS_R = 3;  /* Sc */
        const BIDI_CLASS_AL = 4;  /* Sk */
        const BIDI_CLASS_RLE = 5;  /* Sm */
        const BIDI_CLASS_RLO = 6;  /* So */
        const BIDI_CLASS_PDF = 7;  /* Zl */
        const BIDI_CLASS_EN = 8; /* Zp */
        const BIDI_CLASS_ES = 9;  /* Zs */
    ...
    public static $uni_scriptblock = [
        ...
        23 => 'geor',
        /* SCRIPT_HANGUL */
        24 => 'jamo', /* there is also a hang tag, but we want to activate jamo features if present */
        /* SCRIPT_ETHIOPIC */
        25 => 'ethi',
        /* SCRIPT_CHEROKEE */
        26 => 'cher',
